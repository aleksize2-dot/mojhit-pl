...
genContent = genContent.replace(
  ...
  '<p className="text-[10px] text-center text-primary opacity-90 mt-1 mb-2 md:mb-0 md:mt-4 md:text-on-surface-variant md:opacity-70 leading-relaxed lg:px-4 uppercase tracking-widest font-label font-bold">'
);
